...
inline unsigned int ROTR(unsigned int a, unsigned int b) { return (a >> b) | (a << (32 - b)); }
inline unsigned int SHR(unsigned int a, unsigned int b) { return a >> b; }
...
inline unsigned int sig0(unsigned int x) { return ROTR(x, 7) ^ ROTR(x, 18) ^ SHR(x, 3); }
inline unsigned int sig1(unsigned int x) { return ROTR(x, 17) ^ ROTR(x, 19) ^ SHR(x, 10); }
...
std::string security::generateToken(const std::string& name, const std::string& surname, const std::string& phone, const std::string& role)
{
...
bool security::verifyToken(const std::string& token)
{
    std::string secretKey = "Q2t7HE9lfdIB";
...
std::string security::generatePassword(int length)
{
...
std::array<unsigned int, 8> security::sha256(const std::string& input)
{
