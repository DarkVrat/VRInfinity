...
namespace DB
{
    class visits_smallhall
    {
    public:
        visits_smallhall() : m_id(0), m_start(""), m_end(""), m_visit_id(0) {}
        visits_smallhall(uint32_t id, const std::string& start, const std::string& end, uint32_t visit_id)
